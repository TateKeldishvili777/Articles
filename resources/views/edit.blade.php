...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="height: 100vh;">
        <div class="w-100 h-100 flex-column d-flex justify-content-center align-items-center">
            <h3>edit new task</h3>
            <form class="w-50" method="GET" action="/update/">
                <div class="form-group">
                  <label for="exampleInputEmail1">Title</label>
                <input value="{{ $title }}" name="title" type="text" class="form-control" id="exampleInputTitle1" aria-describedby="emailHelp">
                <input hidden value="{{ $id }}" name="id" type="text" class="form-control" id="exampleInputTitle1" aria-describedby="emailHelp">
                </div>
                <div class="form-group ">
